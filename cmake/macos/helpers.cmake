...
function(set_target_properties_plugin target)
  ...
  if(NOT DEFINED MACOS_BUNDLEID OR MACOS_BUNDLEID STREQUAL "")
    set(MACOS_BUNDLEID "com.obsproject.${target}")
  endif()
  if(NOT DEFINED PLUGIN_BUILD_NUMBER OR PLUGIN_BUILD_NUMBER STREQUAL "")
    set(PLUGIN_BUILD_NUMBER "1")
  endif()
  if(NOT DEFINED PLUGIN_VERSION OR PLUGIN_VERSION STREQUAL "")
    set(PLUGIN_VERSION "1.0.0")
  endif()
  if(NOT DEFINED PLUGIN_AUTHOR OR PLUGIN_AUTHOR STREQUAL "")
    set(PLUGIN_AUTHOR "OBS Project")
  endif()

  string(TIMESTAMP CURRENT_YEAR "%Y")
  set(_copyright "(c) ${CURRENT_YEAR} ${PLUGIN_AUTHOR}")
  set_target_properties(
    ...
    PROPERTIES
      ...
      XCODE_ATTRIBUTE_INFOPLIST_KEY_NSHumanReadableCopyright "${_copyright}"
